...
import { ISubjectSchedule } from "@/models/student"
...
const Schedule = () => {
  ...
  const [listSubjectSchedule, setListSubjectSchedule] = useState<ISubjectSchedule[]>([])

  const columns: TableColumnsType<ISubjectSchedule> = [
    {
      title: 'Số thứ tự',
      key: 'order'
    },
  ...
  return (
    <Flex vertical style={{ width: '100%', height: '100%', padding: 24 }} justify="center" align="center">
      ...
      >
        ...
        <Table loading={loading} pagination={{ showSizeChanger: true }} columns={columns} dataSource={listSubjectSchedule} bordered={false} style={{ width: '100%' }} />
      </Flex>
    </Flex>
  )
}

Schedule.Layout = StudentLayout
